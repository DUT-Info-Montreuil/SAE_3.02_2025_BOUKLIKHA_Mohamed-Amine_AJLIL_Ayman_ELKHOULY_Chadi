...
class ContGestionnaire {
    ...
    public function creerBarman() {
        ...
        // On traite le formulaire si les champs sont soumis
        if (isset($_POST['identifiant'], $_POST['nom'], $_POST['prenom'], $_POST['mdp'])) {
            if ($_POST['identifiant'] !== '' && $_POST['nom'] !== '' && $_POST['prenom'] !== '' && $_POST['mdp'] !== '') {
                ...
                if ($existe) {
                    ...
                    $idBarman = $this->modele->creerBarman($identifiant, $_POST['nom'], $_POST['prenom'], $_POST['mdp']);
    ...
    public function creerFournisseur() {
        ...
        // On traite le formulaire seulement si les champs existent
        if (isset($_POST['nom'], $_POST['telephone'])) {
            if ($_POST['nom'] !== '' && $_POST['telephone'] !== '') {
                $nom = $_POST['nom'];
    ...
    public function creerProduit() {
        ...
        if (isset($_POST['creer'])) {
            if (isset($_POST['nom'], $_POST['type'], $_POST['prix'], $_FILES['image']) && $_POST['nom'] !== '' && $_POST['type'] !== '' && $_POST['prix'] !== '') {
                $nom = $_POST['nom'];
                $type = $_POST['type'];
                $prix = $_POST['prix'];
    ...
    public function validerPanier() {
        if (empty($_SESSION['panier'])) {
            ...
            $idUtilisateur = $_SESSION['id_utilisateur'];
            $idAsso = $this->modele->getAssociationGestionnaire($idUtilisateur);
            $total = 0;
